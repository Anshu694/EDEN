...
const struct mgos_conf_entry mgos_config_schema_[276] = {
  ...
  {.type = CONF_TYPE_OBJECT, .key = "rgb", .offset = offsetof(struct mgos_config, rgb), .num_desc = 14},
  {.type = CONF_TYPE_INT, .key = "r", .offset = offsetof(struct mgos_config, rgb.r)},
  {.type = CONF_TYPE_INT, .key = "g", .offset = offsetof(struct mgos_config, rgb.g)},
  {.type = CONF_TYPE_INT, .key = "b", .offset = offsetof(struct mgos_config, rgb.b)},
  {.type = CONF_TYPE_INT, .key = "fade", .offset = offsetof(struct mgos_config, rgb.fade)},
  {.type = CONF_TYPE_INT, .key = "i", .offset = offsetof(struct mgos_config, rgb.i)},
  {.type = CONF_TYPE_INT, .key = "t1", .offset = offsetof(struct mgos_config, rgb.t1)},
  {.type = CONF_TYPE_INT, .key = "t2", .offset = offsetof(struct mgos_config, rgb.t2)},
  {.type = CONF_TYPE_INT, .key = "no", .offset = offsetof(struct mgos_config, rgb.no)},
  {.type = CONF_TYPE_STRING, .key = "c1", .offset = offsetof(struct mgos_config, rgb.c1)},
  {.type = CONF_TYPE_STRING, .key = "c2", .offset = offsetof(struct mgos_config, rgb.c2)},
  {.type = CONF_TYPE_STRING, .key = "c3", .offset = offsetof(struct mgos_config, rgb.c3)},
  {.type = CONF_TYPE_STRING, .key = "c4", .offset = offsetof(struct mgos_config, rgb.c4)},
  {.type = CONF_TYPE_STRING, .key = "c5", .offset = offsetof(struct mgos_config, rgb.c5)},
  {.type = CONF_TYPE_STRING, .key = "id", .offset = offsetof(struct mgos_config, rgb.id)},
  {.type = CONF_TYPE_OBJECT, .key = "eden", .offset = offsetof(struct mgos_config, eden), .num_desc = 1},
  {.type = CONF_TYPE_INT, .key = "button", .offset = offsetof(struct mgos_config, eden.button)},
};
...
const struct mgos_config mgos_config_defaults = {
  ...
  .rgb.c4 = "00ffff",
  .rgb.c5 = "0000ff",
  .rgb.id = "c9b2b278-5850-4cc6-b346-eef7a798a806",
  .eden.button = 5,
};
...
const struct mgos_conf_entry *mgos_config_schema_rgb(void) {
  return mgos_conf_find_schema_entry("rgb", mgos_config_schema());
}
...
bool mgos_config_copy_rgb(const struct mgos_config_rgb *src, struct mgos_config_rgb *dst) {
  return mgos_conf_copy(mgos_config_schema_rgb(), src, dst);
}
void mgos_config_free_rgb(struct mgos_config_rgb *cfg) {
  return mgos_conf_free(mgos_config_schema_rgb(), cfg);
}
...
void mgos_config_set_rgb_c1(struct mgos_config *cfg, const char * v) {
  mgos_conf_set_str(&cfg->rgb.c1, v);
}
...
void mgos_config_set_rgb_c2(struct mgos_config *cfg, const char * v) {
  mgos_conf_set_str(&cfg->rgb.c2, v);
}
...
void mgos_config_set_rgb_c3(struct mgos_config *cfg, const char * v) {
  mgos_conf_set_str(&cfg->rgb.c3, v);
}
...
void mgos_config_set_rgb_c4(struct mgos_config *cfg, const char * v) {
  mgos_conf_set_str(&cfg->rgb.c4, v);
}
...
void mgos_config_set_rgb_c5(struct mgos_config *cfg, const char * v) {
  mgos_conf_set_str(&cfg->rgb.c5, v);
}
...
void mgos_config_set_rgb_id(struct mgos_config *cfg, const char * v) {
  mgos_conf_set_str(&cfg->rgb.id, v);
}
...
const struct mgos_conf_entry *mgos_config_schema_eden(void) {
  return mgos_conf_find_schema_entry("eden", mgos_config_schema());
}
...
bool mgos_config_copy_eden(const struct mgos_config_eden *src, struct mgos_config_eden *dst) {
  return mgos_conf_copy(mgos_config_schema_eden(), src, dst);
}
void mgos_config_free_eden(struct mgos_config_eden *cfg) {
  return mgos_conf_free(mgos_config_schema_eden(), cfg);
}
