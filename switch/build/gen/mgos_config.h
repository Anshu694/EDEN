...
/* additional.alert type struct mgos_config_additional_alert */
...
static inline bool mgos_config_additional_alert_parse(struct mg_str json, struct mgos_config_additional_alert *cfg) {
  mgos_config_additional_alert_set_defaults(cfg);
  return mgos_conf_parse_sub(json, mgos_config_additional_alert_get_schema(), cfg);
}
static inline bool mgos_config_additional_alert_emit(const struct mgos_config_additional_alert *cfg, bool pretty, struct json_out *out) {
  return mgos_conf_emit_json_out(cfg, NULL, mgos_config_additional_alert_get_schema(), pretty, out);
}
static inline bool mgos_config_additional_alert_emit_f(const struct mgos_config_additional_alert *cfg, bool pretty, const char *fname) {
  return mgos_conf_emit_f(cfg, NULL, mgos_config_additional_alert_get_schema(), pretty, fname);
}
static inline bool mgos_config_additional_alert_copy(const struct mgos_config_additional_alert *src, struct mgos_config_additional_alert *dst) {
  return mgos_conf_copy(mgos_config_additional_alert_get_schema(), src, dst);
}
static inline void mgos_config_additional_alert_free(struct mgos_config_additional_alert *cfg) {
  return mgos_conf_free(mgos_config_additional_alert_get_schema(), cfg);
}

/* additional.timer type struct mgos_config_additional_timer */
...
static inline bool mgos_config_additional_timer_parse(struct mg_str json, struct mgos_config_additional_timer *cfg) {
  mgos_config_additional_timer_set_defaults(cfg);
  return mgos_conf_parse_sub(json, mgos_config_additional_timer_get_schema(), cfg);
}
static inline bool mgos_config_additional_timer_emit(const struct mgos_config_additional_timer *cfg, bool pretty, struct json_out *out) {
  return mgos_conf_emit_json_out(cfg, NULL, mgos_config_additional_timer_get_schema(), pretty, out);
}
static inline bool mgos_config_additional_timer_emit_f(const struct mgos_config_additional_timer *cfg, bool pretty, const char *fname) {
  return mgos_conf_emit_f(cfg, NULL, mgos_config_additional_timer_get_schema(), pretty, fname);
}
static inline bool mgos_config_additional_timer_copy(const struct mgos_config_additional_timer *src, struct mgos_config_additional_timer *dst) {
  return mgos_conf_copy(mgos_config_additional_timer_get_schema(), src, dst);
}
static inline void mgos_config_additional_timer_free(struct mgos_config_additional_timer *cfg) {
  return mgos_conf_free(mgos_config_additional_timer_get_schema(), cfg);
}

/* additional.future type struct mgos_config_additional_future */
...
static inline bool mgos_config_additional_future_parse(struct mg_str json, struct mgos_config_additional_future *cfg) {
  mgos_config_additional_future_set_defaults(cfg);
  return mgos_conf_parse_sub(json, mgos_config_additional_future_get_schema(), cfg);
}
static inline bool mgos_config_additional_future_emit(const struct mgos_config_additional_future *cfg, bool pretty, struct json_out *out) {
  return mgos_conf_emit_json_out(cfg, NULL, mgos_config_additional_future_get_schema(), pretty, out);
}
static inline bool mgos_config_additional_future_emit_f(const struct mgos_config_additional_future *cfg, bool pretty, const char *fname) {
  return mgos_conf_emit_f(cfg, NULL, mgos_config_additional_future_get_schema(), pretty, fname);
}
static inline bool mgos_config_additional_future_copy(const struct mgos_config_additional_future *src, struct mgos_config_additional_future *dst) {
  return mgos_conf_copy(mgos_config_additional_future_get_schema(), src, dst);
}
static inline void mgos_config_additional_future_free(struct mgos_config_additional_future *cfg) {
  return mgos_conf_free(mgos_config_additional_future_get_schema(), cfg);
}

/* additional type struct mgos_config_additional */
...
static inline bool mgos_config_additional_parse(struct mg_str json, struct mgos_config_additional *cfg) {
  mgos_config_additional_set_defaults(cfg);
  return mgos_conf_parse_sub(json, mgos_config_additional_get_schema(), cfg);
}
static inline bool mgos_config_additional_emit(const struct mgos_config_additional *cfg, bool pretty, struct json_out *out) {
  return mgos_conf_emit_json_out(cfg, NULL, mgos_config_additional_get_schema(), pretty, out);
}
static inline bool mgos_config_additional_emit_f(const struct mgos_config_additional *cfg, bool pretty, const char *fname) {
  return mgos_conf_emit_f(cfg, NULL, mgos_config_additional_get_schema(), pretty, fname);
}
static inline bool mgos_config_additional_copy(const struct mgos_config_additional *src, struct mgos_config_additional *dst) {
  return mgos_conf_copy(mgos_config_additional_get_schema(), src, dst);
}
static inline void mgos_config_additional_free(struct mgos_config_additional *cfg) {
  return mgos_conf_free(mgos_config_additional_get_schema(), cfg);
}

/* outputPins type struct mgos_config_outputPins */
...
static inline bool mgos_config_outputPins_parse(struct mg_str json, struct mgos_config_outputPins *cfg) {
  mgos_config_outputPins_set_defaults(cfg);
  return mgos_conf_parse_sub(json, mgos_config_outputPins_get_schema(), cfg);
}
static inline bool mgos_config_outputPins_emit(const struct mgos_config_outputPins *cfg, bool pretty, struct json_out *out) {
  return mgos_conf_emit_json_out(cfg, NULL, mgos_config_outputPins_get_schema(), pretty, out);
}
static inline bool mgos_config_outputPins_emit_f(const struct mgos_config_outputPins *cfg, bool pretty, const char *fname) {
  return mgos_conf_emit_f(cfg, NULL, mgos_config_outputPins_get_schema(), pretty, fname);
}
static inline bool mgos_config_outputPins_copy(const struct mgos_config_outputPins *src, struct mgos_config_outputPins *dst) {
  return mgos_conf_copy(mgos_config_outputPins_get_schema(), src, dst);
}
static inline void mgos_config_outputPins_free(struct mgos_config_outputPins *cfg) {
  return mgos_conf_free(mgos_config_outputPins_get_schema(), cfg);
}

/* inputPins type struct mgos_config_inputPins */
...
static inline bool mgos_config_inputPins_parse(struct mg_str json, struct mgos_config_inputPins *cfg) {
  mgos_config_inputPins_set_defaults(cfg);
  return mgos_conf_parse_sub(json, mgos_config_inputPins_get_schema(), cfg);
}
static inline bool mgos_config_inputPins_emit(const struct mgos_config_inputPins *cfg, bool pretty, struct json_out *out) {
  return mgos_conf_emit_json_out(cfg, NULL, mgos_config_inputPins_get_schema(), pretty, out);
}
static inline bool mgos_config_inputPins_emit_f(const struct mgos_config_inputPins *cfg, bool pretty, const char *fname) {
  return mgos_conf_emit_f(cfg, NULL, mgos_config_inputPins_get_schema(), pretty, fname);
}
static inline bool mgos_config_inputPins_copy(const struct mgos_config_inputPins *src, struct mgos_config_inputPins *dst) {
  return mgos_conf_copy(mgos_config_inputPins_get_schema(), src, dst);
}
static inline void mgos_config_inputPins_free(struct mgos_config_inputPins *cfg) {
  return mgos_conf_free(mgos_config_inputPins_get_schema(), cfg);
}
...
const char * mgos_config_get_mqtt_pub_update(const struct mgos_config *cfg);
const char * mgos_config_get_default_mqtt_pub_update(void);
static inline const char * mgos_sys_config_get_mqtt_pub_update(void) { return mgos_config_get_mqtt_pub_update(&mgos_sys_config); }
static inline const char * mgos_sys_config_get_default_mqtt_pub_update(void) { return mgos_config_get_default_mqtt_pub_update(); }
...
const char * mgos_config_get_mqtt_sub_update(const struct mgos_config *cfg);
const char * mgos_config_get_default_mqtt_sub_update(void);
static inline const char * mgos_sys_config_get_mqtt_sub_update(void) { return mgos_config_get_mqtt_sub_update(&mgos_sys_config); }
static inline const char * mgos_sys_config_get_default_mqtt_sub_update(void) { return mgos_config_get_default_mqtt_sub_update(); }
...
const char * mgos_config_get_mqtt1_pub_update(const struct mgos_config *cfg);
const char * mgos_config_get_default_mqtt1_pub_update(void);
...
static inline const char * mgos_sys_config_get_default_mqtt1_pub_update(void) { return mgos_config_get_default_mqtt1_pub_update(); }
...
const char * mgos_config_get_mqtt1_sub_update(const struct mgos_config *cfg);
const char * mgos_config_get_default_mqtt1_sub_update(void);
...
static inline const char * mgos_sys_config_get_default_mqtt1_sub_update(void) { return mgos_config_get_default_mqtt1_sub_update(); }
...
const struct mgos_config_additional *mgos_config_get_additional(const struct mgos_config *cfg);
...
const struct mgos_config_additional_alert *mgos_config_get_additional_alert(const struct mgos_config *cfg);
...
int mgos_config_get_additional_alert_out_1(const struct mgos_config *cfg);
int mgos_config_get_default_additional_alert_out_1(void);
...
static inline int mgos_sys_config_get_default_additional_alert_out_1(void) { return mgos_config_get_default_additional_alert_out_1(); }
...
int mgos_config_get_additional_alert_out_2(const struct mgos_config *cfg);
int mgos_config_get_default_additional_alert_out_2(void);
...
static inline int mgos_sys_config_get_default_additional_alert_out_2(void) { return mgos_config_get_default_additional_alert_out_2(); }
...
#define MGOS_CONFIG_HAVE_ADDITIONAL_ALERT_OUT_3
#define MGOS_SYS_CONFIG_HAVE_ADDITIONAL_ALERT_OUT_3
int mgos_config_get_additional_alert_out_3(const struct mgos_config *cfg);
int mgos_config_get_default_additional_alert_out_3(void);
static inline int mgos_sys_config_get_additional_alert_out_3(void) { return mgos_config_get_additional_alert_out_3(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_additional_alert_out_3(void) { return mgos_config_get_default_additional_alert_out_3(); }
void mgos_config_set_additional_alert_out_3(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_additional_alert_out_3(int v) { mgos_config_set_additional_alert_out_3(&mgos_sys_config, v); }

/* additional.alert.out_4 */
#define MGOS_CONFIG_HAVE_ADDITIONAL_ALERT_OUT_4
#define MGOS_SYS_CONFIG_HAVE_ADDITIONAL_ALERT_OUT_4
int mgos_config_get_additional_alert_out_4(const struct mgos_config *cfg);
int mgos_config_get_default_additional_alert_out_4(void);
static inline int mgos_sys_config_get_additional_alert_out_4(void) { return mgos_config_get_additional_alert_out_4(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_additional_alert_out_4(void) { return mgos_config_get_default_additional_alert_out_4(); }
void mgos_config_set_additional_alert_out_4(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_additional_alert_out_4(int v) { mgos_config_set_additional_alert_out_4(&mgos_sys_config, v); }

/* additional.timer */
#define MGOS_CONFIG_HAVE_ADDITIONAL_TIMER
#define MGOS_SYS_CONFIG_HAVE_ADDITIONAL_TIMER
const struct mgos_config_additional_timer *mgos_config_get_additional_timer(const struct mgos_config *cfg);
...
int mgos_config_get_additional_timer_out_1(const struct mgos_config *cfg);
int mgos_config_get_default_additional_timer_out_1(void);
...
static inline int mgos_sys_config_get_default_additional_timer_out_1(void) { return mgos_config_get_default_additional_timer_out_1(); }
...
int mgos_config_get_additional_timer_out_2(const struct mgos_config *cfg);
int mgos_config_get_default_additional_timer_out_2(void);
...
static inline int mgos_sys_config_get_default_additional_timer_out_2(void) { return mgos_config_get_default_additional_timer_out_2(); }
...
#define MGOS_CONFIG_HAVE_ADDITIONAL_TIMER_OUT_3
#define MGOS_SYS_CONFIG_HAVE_ADDITIONAL_TIMER_OUT_3
int mgos_config_get_additional_timer_out_3(const struct mgos_config *cfg);
int mgos_config_get_default_additional_timer_out_3(void);
static inline int mgos_sys_config_get_additional_timer_out_3(void) { return mgos_config_get_additional_timer_out_3(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_additional_timer_out_3(void) { return mgos_config_get_default_additional_timer_out_3(); }
void mgos_config_set_additional_timer_out_3(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_additional_timer_out_3(int v) { mgos_config_set_additional_timer_out_3(&mgos_sys_config, v); }

/* additional.timer.out_4 */
#define MGOS_CONFIG_HAVE_ADDITIONAL_TIMER_OUT_4
#define MGOS_SYS_CONFIG_HAVE_ADDITIONAL_TIMER_OUT_4
int mgos_config_get_additional_timer_out_4(const struct mgos_config *cfg);
int mgos_config_get_default_additional_timer_out_4(void);
static inline int mgos_sys_config_get_additional_timer_out_4(void) { return mgos_config_get_additional_timer_out_4(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_additional_timer_out_4(void) { return mgos_config_get_default_additional_timer_out_4(); }
void mgos_config_set_additional_timer_out_4(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_additional_timer_out_4(int v) { mgos_config_set_additional_timer_out_4(&mgos_sys_config, v); }

/* additional.future */
#define MGOS_CONFIG_HAVE_ADDITIONAL_FUTURE
#define MGOS_SYS_CONFIG_HAVE_ADDITIONAL_FUTURE
const struct mgos_config_additional_future *mgos_config_get_additional_future(const struct mgos_config *cfg);
...
int mgos_config_get_additional_future_out_1(const struct mgos_config *cfg);
int mgos_config_get_default_additional_future_out_1(void);
...
static inline int mgos_sys_config_get_default_additional_future_out_1(void) { return mgos_config_get_default_additional_future_out_1(); }
...
int mgos_config_get_additional_future_out_2(const struct mgos_config *cfg);
int mgos_config_get_default_additional_future_out_2(void);
...
static inline int mgos_sys_config_get_default_additional_future_out_2(void) { return mgos_config_get_default_additional_future_out_2(); }
...
#define MGOS_CONFIG_HAVE_ADDITIONAL_FUTURE_OUT_3
#define MGOS_SYS_CONFIG_HAVE_ADDITIONAL_FUTURE_OUT_3
int mgos_config_get_additional_future_out_3(const struct mgos_config *cfg);
int mgos_config_get_default_additional_future_out_3(void);
static inline int mgos_sys_config_get_additional_future_out_3(void) { return mgos_config_get_additional_future_out_3(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_additional_future_out_3(void) { return mgos_config_get_default_additional_future_out_3(); }
void mgos_config_set_additional_future_out_3(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_additional_future_out_3(int v) { mgos_config_set_additional_future_out_3(&mgos_sys_config, v); }

/* additional.future.out_4 */
#define MGOS_CONFIG_HAVE_ADDITIONAL_FUTURE_OUT_4
#define MGOS_SYS_CONFIG_HAVE_ADDITIONAL_FUTURE_OUT_4
int mgos_config_get_additional_future_out_4(const struct mgos_config *cfg);
int mgos_config_get_default_additional_future_out_4(void);
static inline int mgos_sys_config_get_additional_future_out_4(void) { return mgos_config_get_additional_future_out_4(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_additional_future_out_4(void) { return mgos_config_get_default_additional_future_out_4(); }
void mgos_config_set_additional_future_out_4(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_additional_future_out_4(int v) { mgos_config_set_additional_future_out_4(&mgos_sys_config, v); }

/* outputPins */
#define MGOS_CONFIG_HAVE_OUTPUTPINS
#define MGOS_SYS_CONFIG_HAVE_OUTPUTPINS
const struct mgos_config_outputPins *mgos_config_get_outputPins(const struct mgos_config *cfg);
...
int mgos_config_get_outputPins_out_1(const struct mgos_config *cfg);
int mgos_config_get_default_outputPins_out_1(void);
static inline int mgos_sys_config_get_outputPins_out_1(void) { return mgos_config_get_outputPins_out_1(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_outputPins_out_1(void) { return mgos_config_get_default_outputPins_out_1(); }
...
int mgos_config_get_outputPins_out_2(const struct mgos_config *cfg);
int mgos_config_get_default_outputPins_out_2(void);
static inline int mgos_sys_config_get_outputPins_out_2(void) { return mgos_config_get_outputPins_out_2(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_outputPins_out_2(void) { return mgos_config_get_default_outputPins_out_2(); }
...
/* outputPins.out_3 */
#define MGOS_CONFIG_HAVE_OUTPUTPINS_OUT_3
#define MGOS_SYS_CONFIG_HAVE_OUTPUTPINS_OUT_3
int mgos_config_get_outputPins_out_3(const struct mgos_config *cfg);
int mgos_config_get_default_outputPins_out_3(void);
static inline int mgos_sys_config_get_outputPins_out_3(void) { return mgos_config_get_outputPins_out_3(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_outputPins_out_3(void) { return mgos_config_get_default_outputPins_out_3(); }
void mgos_config_set_outputPins_out_3(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_outputPins_out_3(int v) { mgos_config_set_outputPins_out_3(&mgos_sys_config, v); }

/* outputPins.out_4 */
#define MGOS_CONFIG_HAVE_OUTPUTPINS_OUT_4
#define MGOS_SYS_CONFIG_HAVE_OUTPUTPINS_OUT_4
int mgos_config_get_outputPins_out_4(const struct mgos_config *cfg);
int mgos_config_get_default_outputPins_out_4(void);
static inline int mgos_sys_config_get_outputPins_out_4(void) { return mgos_config_get_outputPins_out_4(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_outputPins_out_4(void) { return mgos_config_get_default_outputPins_out_4(); }
void mgos_config_set_outputPins_out_4(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_outputPins_out_4(int v) { mgos_config_set_outputPins_out_4(&mgos_sys_config, v); }

/* inputPins */
#define MGOS_CONFIG_HAVE_INPUTPINS
#define MGOS_SYS_CONFIG_HAVE_INPUTPINS
const struct mgos_config_inputPins *mgos_config_get_inputPins(const struct mgos_config *cfg);
...
int mgos_config_get_inputPins_in_1(const struct mgos_config *cfg);
int mgos_config_get_default_inputPins_in_1(void);
static inline int mgos_sys_config_get_inputPins_in_1(void) { return mgos_config_get_inputPins_in_1(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_inputPins_in_1(void) { return mgos_config_get_default_inputPins_in_1(); }
...
int mgos_config_get_inputPins_in_2(const struct mgos_config *cfg);
int mgos_config_get_default_inputPins_in_2(void);
static inline int mgos_sys_config_get_inputPins_in_2(void) { return mgos_config_get_inputPins_in_2(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_inputPins_in_2(void) { return mgos_config_get_default_inputPins_in_2(); }
...
/* inputPins.in_3 */
#define MGOS_CONFIG_HAVE_INPUTPINS_IN_3
#define MGOS_SYS_CONFIG_HAVE_INPUTPINS_IN_3
int mgos_config_get_inputPins_in_3(const struct mgos_config *cfg);
int mgos_config_get_default_inputPins_in_3(void);
static inline int mgos_sys_config_get_inputPins_in_3(void) { return mgos_config_get_inputPins_in_3(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_inputPins_in_3(void) { return mgos_config_get_default_inputPins_in_3(); }
void mgos_config_set_inputPins_in_3(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_inputPins_in_3(int v) { mgos_config_set_inputPins_in_3(&mgos_sys_config, v); }

/* inputPins.in_4 */
#define MGOS_CONFIG_HAVE_INPUTPINS_IN_4
#define MGOS_SYS_CONFIG_HAVE_INPUTPINS_IN_4
int mgos_config_get_inputPins_in_4(const struct mgos_config *cfg);
int mgos_config_get_default_inputPins_in_4(void);
static inline int mgos_sys_config_get_inputPins_in_4(void) { return mgos_config_get_inputPins_in_4(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_inputPins_in_4(void) { return mgos_config_get_default_inputPins_in_4(); }
void mgos_config_set_inputPins_in_4(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_inputPins_in_4(int v) { mgos_config_set_inputPins_in_4(&mgos_sys_config, v); }
