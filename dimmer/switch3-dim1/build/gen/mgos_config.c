 ...
 * Command: /mongoose-os/tools/mgos_gen_config.py --c_name=mgos_config --c_global_name=mgos_sys_config --dest_dir=/data/fwbuild-volumes/2.18.0/apps/EDEN_4/esp8266/build_contexts/build_ctx_816226078/build/gen/ /mongoose-os/src/mgos_debug_udp_config.yaml /data/fwbuild-volumes/2.18.0/apps/EDEN_4/esp8266/build_contexts/build_ctx_816226078/build/gen/mos_conf_schema.yml
 */
...
const struct mgos_conf_entry mgos_config_schema_[289] = {
  {.type = CONF_TYPE_OBJECT, .key = "", .offset = 0, .num_desc = 288},
  ...
  {.type = CONF_TYPE_OBJECT, .key = "outputPins", .offset = offsetof(struct mgos_config, outputPins), .num_desc = 8},
  {.type = CONF_TYPE_INT, .key = "state_1", .offset = offsetof(struct mgos_config, outputPins.state_1)},
  {.type = CONF_TYPE_INT, .key = "state_2", .offset = offsetof(struct mgos_config, outputPins.state_2)},
  {.type = CONF_TYPE_INT, .key = "state_3", .offset = offsetof(struct mgos_config, outputPins.state_3)},
  {.type = CONF_TYPE_INT, .key = "state_4", .offset = offsetof(struct mgos_config, outputPins.state_4)},
  {.type = CONF_TYPE_INT, .key = "dim_1", .offset = offsetof(struct mgos_config, outputPins.dim_1)},
  {.type = CONF_TYPE_INT, .key = "dim_2", .offset = offsetof(struct mgos_config, outputPins.dim_2)},
  {.type = CONF_TYPE_INT, .key = "dim_3", .offset = offsetof(struct mgos_config, outputPins.dim_3)},
  {.type = CONF_TYPE_INT, .key = "dim_4", .offset = offsetof(struct mgos_config, outputPins.dim_4)},
  {.type = CONF_TYPE_OBJECT, .key = "inputPins", .offset = offsetof(struct mgos_config, inputPins), .num_desc = 4},
  {.type = CONF_TYPE_INT, .key = "state_1", .offset = offsetof(struct mgos_config, inputPins.state_1)},
  {.type = CONF_TYPE_INT, .key = "state_2", .offset = offsetof(struct mgos_config, inputPins.state_2)},
  {.type = CONF_TYPE_INT, .key = "state_3", .offset = offsetof(struct mgos_config, inputPins.state_3)},
  {.type = CONF_TYPE_INT, .key = "state_4", .offset = offsetof(struct mgos_config, inputPins.state_4)},
};
...
const struct mgos_config mgos_config_defaults = {
  ...
  .conf_acl = "*",
  .mqtt.enable = 1,
  .mqtt.server = "a6ffpc9686vd8-ats.iot.us-west-2.amazonaws.com:8883",
  .mqtt.client_id = NULL,
  .mqtt.user = NULL,
  .mqtt.pass = NULL,
  ...
  .mqtt.pub = "?????\?/response",
  .mqtt.sub = "?????\?/request",
  .mqtt.pub_update = "?????\?/response/update",
  .mqtt.sub_update = "?????\?/request/update",
  .mqtt1.enable = 0,
  .mqtt1.server = NULL,
  ...
  .mqtt1.ssl_cert = "aws-??????.crt.pem",
  .mqtt1.ssl_key = "aws-??????.key.pem",
  ...
  .mqtt1.pub = "?????\?/response",
  .mqtt1.sub = "?????\?/request",
  .mqtt1.pub_update = "?????\?/response/update",
  .mqtt1.sub_update = "?????\?/request/update",
  .shadow.enable = 1,
  .shadow.lib = NULL,
  ...
  .file_logger.timestamps = 1,
  .file_logger.level = 2,
  .file_logger.include = NULL,
  .file_logger.syslog_enable = 1,
  .file_logger.rpc_service_enable = 0,
  .file_logger.buf_size = 256,
  .file_logger.buf_line = 1,
  .http.enable = 1,
  .http.listen_addr = "80",
  .http.document_root = "/",
  ...
  .additional.alert.out_4 = 0,
  .additional.timer.out_1 = 0,
  .additional.timer.out_2 = 0,
  .additional.timer.out_3 = 0,
  .additional.timer.out_4 = 0,
  .additional.future.out_1 = 0,
  .additional.future.out_2 = 0,
  .additional.future.out_3 = 0,
  .additional.future.out_4 = 0,
  .outputPins.state_1 = 0,
  .outputPins.state_2 = 0,
  .outputPins.state_3 = 0,
  .outputPins.state_4 = 0,
  .outputPins.dim_1 = 0,
  .outputPins.dim_2 = 0,
  .outputPins.dim_3 = 0,
  .outputPins.dim_4 = 50,
...
const struct mgos_conf_entry *mgos_config_schema_file_logger(void) {
  return mgos_conf_find_schema_entry("file_logger", mgos_config_schema());
}
...
bool mgos_config_copy_file_logger(const struct mgos_config_file_logger *src, struct mgos_config_file_logger *dst) {
  return mgos_conf_copy(mgos_config_schema_file_logger(), src, dst);
}
void mgos_config_free_file_logger(struct mgos_config_file_logger *cfg) {
  return mgos_conf_free(mgos_config_schema_file_logger(), cfg);
}
...
void mgos_config_set_file_logger_dir(struct mgos_config *cfg, const char * v) {
  mgos_conf_set_str(&cfg->file_logger.dir, v);
}
...
void mgos_config_set_file_logger_prefix(struct mgos_config *cfg, const char * v) {
  mgos_conf_set_str(&cfg->file_logger.prefix, v);
}
...
void mgos_config_set_file_logger_max_file_size(struct mgos_config *cfg, int v) {
  cfg->file_logger.max_file_size = v;
}
...
void mgos_config_set_file_logger_max_num_files(struct mgos_config *cfg, int v) {
  cfg->file_logger.max_num_files = v;
}
...
const struct mgos_config_additional * mgos_config_get_additional(struct mgos_config *cfg) {
  return &cfg->additional;
}
const struct mgos_conf_entry *mgos_config_schema_additional(void) {
  return mgos_conf_find_schema_entry("additional", mgos_config_schema());
}
...
bool mgos_config_copy_additional(const struct mgos_config_additional *src, struct mgos_config_additional *dst) {
  return mgos_conf_copy(mgos_config_schema_additional(), src, dst);
}
void mgos_config_free_additional(struct mgos_config_additional *cfg) {
  return mgos_conf_free(mgos_config_schema_additional(), cfg);
}
...
const struct mgos_config_additional_alert * mgos_config_get_additional_alert(struct mgos_config *cfg) {
  return &cfg->additional.alert;
}
const struct mgos_conf_entry *mgos_config_schema_additional_alert(void) {
  return mgos_conf_find_schema_entry("additional.alert", mgos_config_schema());
}
...
bool mgos_config_copy_additional_alert(const struct mgos_config_additional_alert *src, struct mgos_config_additional_alert *dst) {
  return mgos_conf_copy(mgos_config_schema_additional_alert(), src, dst);
}
void mgos_config_free_additional_alert(struct mgos_config_additional_alert *cfg) {
  return mgos_conf_free(mgos_config_schema_additional_alert(), cfg);
}
...
const struct mgos_config_additional_timer * mgos_config_get_additional_timer(struct mgos_config *cfg) {
  return &cfg->additional.timer;
}
const struct mgos_conf_entry *mgos_config_schema_additional_timer(void) {
  return mgos_conf_find_schema_entry("additional.timer", mgos_config_schema());
}
...
bool mgos_config_copy_additional_timer(const struct mgos_config_additional_timer *src, struct mgos_config_additional_timer *dst) {
  return mgos_conf_copy(mgos_config_schema_additional_timer(), src, dst);
}
void mgos_config_free_additional_timer(struct mgos_config_additional_timer *cfg) {
  return mgos_conf_free(mgos_config_schema_additional_timer(), cfg);
}
...
const struct mgos_config_additional_future * mgos_config_get_additional_future(struct mgos_config *cfg) {
  return &cfg->additional.future;
}
const struct mgos_conf_entry *mgos_config_schema_additional_future(void) {
  return mgos_conf_find_schema_entry("additional.future", mgos_config_schema());
}
...
bool mgos_config_copy_additional_future(const struct mgos_config_additional_future *src, struct mgos_config_additional_future *dst) {
  return mgos_conf_copy(mgos_config_schema_additional_future(), src, dst);
}
void mgos_config_free_additional_future(struct mgos_config_additional_future *cfg) {
  return mgos_conf_free(mgos_config_schema_additional_future(), cfg);
}
...
int mgos_config_get_additional_future_out_3(struct mgos_config *cfg) {
  return cfg->additional.future.out_3;
}
void mgos_config_set_additional_future_out_3(struct mgos_config *cfg, int v) {
  cfg->additional.future.out_3 = v;
}
...
int mgos_config_get_additional_future_out_4(struct mgos_config *cfg) {
  return cfg->additional.future.out_4;
}
void mgos_config_set_additional_future_out_4(struct mgos_config *cfg, int v) {
  cfg->additional.future.out_4 = v;
}
...
const struct mgos_config_outputPins * mgos_config_get_outputPins(struct mgos_config *cfg) {
  return &cfg->outputPins;
}
const struct mgos_conf_entry *mgos_config_schema_outputPins(void) {
  return mgos_conf_find_schema_entry("outputPins", mgos_config_schema());
}
...
bool mgos_config_copy_outputPins(const struct mgos_config_outputPins *src, struct mgos_config_outputPins *dst) {
  return mgos_conf_copy(mgos_config_schema_outputPins(), src, dst);
}
void mgos_config_free_outputPins(struct mgos_config_outputPins *cfg) {
  return mgos_conf_free(mgos_config_schema_outputPins(), cfg);
}

/* outputPins.state_1 */
#define MGOS_CONFIG_HAVE_OUTPUTPINS_STATE_1
#define MGOS_SYS_CONFIG_HAVE_OUTPUTPINS_STATE_1
int mgos_config_get_outputPins_state_1(struct mgos_config *cfg) {
  return cfg->outputPins.state_1;
}
void mgos_config_set_outputPins_state_1(struct mgos_config *cfg, int v) {
  cfg->outputPins.state_1 = v;
}

/* outputPins.state_2 */
#define MGOS_CONFIG_HAVE_OUTPUTPINS_STATE_2
#define MGOS_SYS_CONFIG_HAVE_OUTPUTPINS_STATE_2
int mgos_config_get_outputPins_state_2(struct mgos_config *cfg) {
  return cfg->outputPins.state_2;
}
void mgos_config_set_outputPins_state_2(struct mgos_config *cfg, int v) {
  cfg->outputPins.state_2 = v;
}

/* outputPins.state_3 */
#define MGOS_CONFIG_HAVE_OUTPUTPINS_STATE_3
#define MGOS_SYS_CONFIG_HAVE_OUTPUTPINS_STATE_3
int mgos_config_get_outputPins_state_3(struct mgos_config *cfg) {
  return cfg->outputPins.state_3;
}
void mgos_config_set_outputPins_state_3(struct mgos_config *cfg, int v) {
  cfg->outputPins.state_3 = v;
}

/* outputPins.state_4 */
#define MGOS_CONFIG_HAVE_OUTPUTPINS_STATE_4
#define MGOS_SYS_CONFIG_HAVE_OUTPUTPINS_STATE_4
int mgos_config_get_outputPins_state_4(struct mgos_config *cfg) {
  return cfg->outputPins.state_4;
}
void mgos_config_set_outputPins_state_4(struct mgos_config *cfg, int v) {
  cfg->outputPins.state_4 = v;
}

/* outputPins.dim_1 */
#define MGOS_CONFIG_HAVE_OUTPUTPINS_DIM_1
#define MGOS_SYS_CONFIG_HAVE_OUTPUTPINS_DIM_1
int mgos_config_get_outputPins_dim_1(struct mgos_config *cfg) {
  return cfg->outputPins.dim_1;
}
void mgos_config_set_outputPins_dim_1(struct mgos_config *cfg, int v) {
  cfg->outputPins.dim_1 = v;
}

/* outputPins.dim_2 */
#define MGOS_CONFIG_HAVE_OUTPUTPINS_DIM_2
#define MGOS_SYS_CONFIG_HAVE_OUTPUTPINS_DIM_2
int mgos_config_get_outputPins_dim_2(struct mgos_config *cfg) {
  return cfg->outputPins.dim_2;
}
void mgos_config_set_outputPins_dim_2(struct mgos_config *cfg, int v) {
  cfg->outputPins.dim_2 = v;
}

/* outputPins.dim_3 */
#define MGOS_CONFIG_HAVE_OUTPUTPINS_DIM_3
#define MGOS_SYS_CONFIG_HAVE_OUTPUTPINS_DIM_3
int mgos_config_get_outputPins_dim_3(struct mgos_config *cfg) {
  return cfg->outputPins.dim_3;
}
void mgos_config_set_outputPins_dim_3(struct mgos_config *cfg, int v) {
  cfg->outputPins.dim_3 = v;
}

/* outputPins.dim_4 */
#define MGOS_CONFIG_HAVE_OUTPUTPINS_DIM_4
#define MGOS_SYS_CONFIG_HAVE_OUTPUTPINS_DIM_4
int mgos_config_get_outputPins_dim_4(struct mgos_config *cfg) {
  return cfg->outputPins.dim_4;
}
void mgos_config_set_outputPins_dim_4(struct mgos_config *cfg, int v) {
  cfg->outputPins.dim_4 = v;
}
...
const struct mgos_config_inputPins * mgos_config_get_inputPins(struct mgos_config *cfg) {
  return &cfg->inputPins;
}
const struct mgos_conf_entry *mgos_config_schema_inputPins(void) {
  return mgos_conf_find_schema_entry("inputPins", mgos_config_schema());
}
...
bool mgos_config_copy_inputPins(const struct mgos_config_inputPins *src, struct mgos_config_inputPins *dst) {
  return mgos_conf_copy(mgos_config_schema_inputPins(), src, dst);
}
void mgos_config_free_inputPins(struct mgos_config_inputPins *cfg) {
  return mgos_conf_free(mgos_config_schema_inputPins(), cfg);
}

/* inputPins.state_1 */
#define MGOS_CONFIG_HAVE_INPUTPINS_STATE_1
#define MGOS_SYS_CONFIG_HAVE_INPUTPINS_STATE_1
int mgos_config_get_inputPins_state_1(struct mgos_config *cfg) {
  return cfg->inputPins.state_1;
}
void mgos_config_set_inputPins_state_1(struct mgos_config *cfg, int v) {
  cfg->inputPins.state_1 = v;
}

/* inputPins.state_2 */
#define MGOS_CONFIG_HAVE_INPUTPINS_STATE_2
#define MGOS_SYS_CONFIG_HAVE_INPUTPINS_STATE_2
int mgos_config_get_inputPins_state_2(struct mgos_config *cfg) {
  return cfg->inputPins.state_2;
}
void mgos_config_set_inputPins_state_2(struct mgos_config *cfg, int v) {
  cfg->inputPins.state_2 = v;
}

/* inputPins.state_3 */
#define MGOS_CONFIG_HAVE_INPUTPINS_STATE_3
#define MGOS_SYS_CONFIG_HAVE_INPUTPINS_STATE_3
int mgos_config_get_inputPins_state_3(struct mgos_config *cfg) {
  return cfg->inputPins.state_3;
}
void mgos_config_set_inputPins_state_3(struct mgos_config *cfg, int v) {
  cfg->inputPins.state_3 = v;
}

/* inputPins.state_4 */
#define MGOS_CONFIG_HAVE_INPUTPINS_STATE_4
#define MGOS_SYS_CONFIG_HAVE_INPUTPINS_STATE_4
int mgos_config_get_inputPins_state_4(struct mgos_config *cfg) {
  return cfg->inputPins.state_4;
}
void mgos_config_set_inputPins_state_4(struct mgos_config *cfg, int v) {
  cfg->inputPins.state_4 = v;
}
