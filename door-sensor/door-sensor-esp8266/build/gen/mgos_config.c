 ...
 * Command: /mongoose-os/tools/mgos_gen_config.py --c_name=mgos_config --c_global_name=mgos_sys_config --dest_dir=/data/fwbuild-volumes/2.18.0/apps/EDEN_DS/esp8266/build_contexts/build_ctx_786796133/build/gen/ /mongoose-os/src/mgos_debug_udp_config.yaml /data/fwbuild-volumes/2.18.0/apps/EDEN_DS/esp8266/build_contexts/build_ctx_786796133/build/gen/mos_conf_schema.yml
 */
...
const struct mgos_conf_entry mgos_config_schema_[230] = {
...
const struct mgos_config mgos_config_defaults = {
  ...
  .wifi.ap.disable_after = 150,
  .wifi.ap.hostname = NULL,
  .wifi.ap.keep_enabled = 1,
  .wifi.sta.enable = 1,
  .wifi.sta.ssid = "eden",
  .wifi.sta.pass = "eden1234",
  .wifi.sta.user = NULL,
