 ...
 * Command: /mongoose-os/tools/mgos_gen_config.py --c_name=mgos_config --c_global_name=mgos_sys_config --dest_dir=/data/fwbuild-volumes/2.18.0/apps/EDEN_4F/esp32/build_contexts/build_ctx_682490631/build/gen/ /mongoose-os/src/mgos_debug_udp_config.yaml /mongoose-os/platforms/esp32/src/esp32_sys_config.yaml /data/fwbuild-volumes/2.18.0/apps/EDEN_4F/esp32/build_contexts/build_ctx_682490631/build/gen/mos_conf_schema.yml
 */
...
const struct mgos_conf_entry mgos_config_schema_[295] = {
  {.type = CONF_TYPE_OBJECT, .key = "", .offset = 0, .num_desc = 294},
  ...
  {.type = CONF_TYPE_OBJECT, .key = "outputPins", .offset = offsetof(struct mgos_config, outputPins), .num_desc = 5},
  ...
  {.type = CONF_TYPE_INT, .key = "reg", .offset = offsetof(struct mgos_config, outputPins.reg)},
...
int mgos_config_get_outputPins_out_2(struct mgos_config *cfg) {
  return cfg->outputPins.out_2;
}
void mgos_config_set_outputPins_out_2(struct mgos_config *cfg, int v) {
  cfg->outputPins.out_2 = v;
}

/* outputPins.out_3 */
#define MGOS_CONFIG_HAVE_OUTPUTPINS_OUT_3
#define MGOS_SYS_CONFIG_HAVE_OUTPUTPINS_OUT_3
int mgos_config_get_outputPins_out_3(struct mgos_config *cfg) {
  return cfg->outputPins.out_3;
}
void mgos_config_set_outputPins_out_3(struct mgos_config *cfg, int v) {
  cfg->outputPins.out_3 = v;
}

/* outputPins.out_4 */
#define MGOS_CONFIG_HAVE_OUTPUTPINS_OUT_4
#define MGOS_SYS_CONFIG_HAVE_OUTPUTPINS_OUT_4
int mgos_config_get_outputPins_out_4(struct mgos_config *cfg) {
  return cfg->outputPins.out_4;
}
void mgos_config_set_outputPins_out_4(struct mgos_config *cfg, int v) {
  cfg->outputPins.out_4 = v;
}

/* outputPins.reg */
#define MGOS_CONFIG_HAVE_OUTPUTPINS_REG
#define MGOS_SYS_CONFIG_HAVE_OUTPUTPINS_REG
int mgos_config_get_outputPins_reg(struct mgos_config *cfg) {
  return cfg->outputPins.reg;
}
void mgos_config_set_outputPins_reg(struct mgos_config *cfg, int v) {
  cfg->outputPins.reg = v;
}
