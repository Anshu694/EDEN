...
static inline int mgos_sys_config_get_outputPins_reg(void) { return mgos_config_get_outputPins_reg(&mgos_sys_config); }
void mgos_config_set_outputPins_reg(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_outputPins_reg(int v) { mgos_config_set_outputPins_reg(&mgos_sys_config, v); }
