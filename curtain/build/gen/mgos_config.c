 ...
 * Command: /mongoose-os/tools/mgos_gen_config.py --c_name=mgos_config --c_global_name=mgos_sys_config --dest_dir=/data/fwbuild-volumes/2.18.0/apps/EDEN_C/esp8266/build_contexts/build_ctx_732195344/build/gen/ /mongoose-os/src/mgos_debug_udp_config.yaml /data/fwbuild-volumes/2.18.0/apps/EDEN_C/esp8266/build_contexts/build_ctx_732195344/build/gen/mos_conf_schema.yml
 */
...
const struct mgos_conf_entry mgos_config_schema_[276] = {
  ...
  {.type = CONF_TYPE_OBJECT, .key = "additional", .offset = offsetof(struct mgos_config, additional), .num_desc = 9},
  {.type = CONF_TYPE_OBJECT, .key = "alert", .offset = offsetof(struct mgos_config, additional.alert), .num_desc = 2},
  ...
  {.type = CONF_TYPE_OBJECT, .key = "timer", .offset = offsetof(struct mgos_config, additional.timer), .num_desc = 2},
  ...
  {.type = CONF_TYPE_OBJECT, .key = "future", .offset = offsetof(struct mgos_config, additional.future), .num_desc = 2},
  ...
  {.type = CONF_TYPE_INT, .key = "time", .offset = offsetof(struct mgos_config, outputPins.time)},
  {.type = CONF_TYPE_OBJECT, .key = "inputPins", .offset = offsetof(struct mgos_config, inputPins), .num_desc = 2},
